...
/**
 * @brief Definition of what a function that is executed when a window should be closed should look like
 * @param BTKWindow* The window that is supposed to close
 */
 ...
 * @param win A pointer to a GLFWwindow, the underlying windowing library we are using
 * @param app A pointer to a BTKApplication.
 * @param flags Flags for the window. For more info look at BTKWindowFlags
 * @param parameter-name description
 */
struct BTKWindow {
    GLFWwindow* win;
    BTKApplication* app;
    BTKWindowFlags flags;
